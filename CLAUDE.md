...
- **Thursday (squash) is a 2500 day, not 2300.** The binary training/rest rule was coding the week's *highest*-expenditure day as a rest day (~400–600 kcal for a game, on top of a day with no lifting to offset it). Found 2026-08-12. This is the only actionable finding the squash-restructure review produced, and it sits on the ~10-point nutrition axis rather than the <1-point layout axis.
