...
|---|---|---|
| `CLAUDE.md` | Methodology paragraphs (nutrition-rebuild logic, protein-plateau logic, measurement-protocol structure) | Profile block, baseline numbers, every kcal/protein figure derived from one person's lean mass |
...
| 2 | Calories | Weight trend flat 3+ weeks with progression stalling → +150 kcal, not +5 sets | `program.md:192`, `CLAUDE.md:15` |
